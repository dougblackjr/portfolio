<template>
  <div class="frontpage">
    <div class="frontpage-content">
      ...
      <ul class="frontpage-content__links">
...
var sites = [
  {
    ...
    image: 'aces.png',
    thumb: '',
    mobileImage: 'aces_mobile.png',
    description: 'Home improvement site, simple contact form'
  },
  {
    name: 'Doug Black',
    url: 'dougblackjr.com',
    image: 'dougblackjr.png',
    thumb: '',
    mobileImage: 'dougblackjr_mobile.png',
    description: ''
  },
  {
    name: 'Never Give Up',
